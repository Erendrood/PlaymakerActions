...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Button + Direction Input. When a Button is pressed, sends an event based on current axis direction, i.e. up+button, left+button for fighting games, combos etc")]
